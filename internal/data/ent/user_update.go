...
func (uu *UserUpdate) AddArticleIDs(ids ...string) *UserUpdate {
...
func (uu *UserUpdate) RemoveArticleIDs(ids ...string) *UserUpdate {
...
// AddArticleIDs adds the "articles" edge to the Article entity by IDs.
func (uuo *UserUpdateOne) AddArticleIDs(ids ...string) *UserUpdateOne {
...
// RemoveArticleIDs removes the "articles" edge to Article entities by IDs.
func (uuo *UserUpdateOne) RemoveArticleIDs(ids ...string) *UserUpdateOne {
