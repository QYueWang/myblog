...
const OperationArticleServiceCreateArticle = "/api.v1.article.ArticleService/CreateArticle"
const OperationArticleServiceDeleteArticle = "/api.v1.article.ArticleService/DeleteArticle"
const OperationArticleServiceGetArticle = "/api.v1.article.ArticleService/GetArticle"
const OperationArticleServiceListArticle = "/api.v1.article.ArticleService/ListArticle"
const OperationArticleServiceUpdateArticle = "/api.v1.article.ArticleService/UpdateArticle"
...
func RegisterArticleServiceHTTPServer(s *http.Server, srv ArticleServiceHTTPServer) {
	r := s.Route("/")
	r.POST("/api/article", _ArticleService_CreateArticle0_HTTP_Handler(srv))
	r.PUT("/api/article/{id}", _ArticleService_UpdateArticle0_HTTP_Handler(srv))
	r.DELETE("/api/article/{id}", _ArticleService_DeleteArticle0_HTTP_Handler(srv))
	r.GET("/api/article/{id}", _ArticleService_GetArticle0_HTTP_Handler(srv))
	r.GET("/api/articles", _ArticleService_ListArticle0_HTTP_Handler(srv))
}
