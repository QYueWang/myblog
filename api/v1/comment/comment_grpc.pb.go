...
const (
	CommentService_CreateComment_FullMethodName = "/api.v1.comment.CommentService/CreateComment"
	CommentService_DeleteComment_FullMethodName = "/api.v1.comment.CommentService/DeleteComment"
	CommentService_GetComments_FullMethodName   = "/api.v1.comment.CommentService/GetComments"
)
...
func (c *commentServiceClient) GetComments(ctx context.Context, in *GetCommentRequest, opts ...grpc.CallOption) (*GetCommentReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedCommentServiceServer) GetComments(context.Context, *GetCommentRequest) (*GetCommentReply, error) {
...
func _CommentService_GetComments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CommentServiceServer).GetComments(ctx, req.(*GetCommentRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CommentService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.v1.comment.CommentService",
